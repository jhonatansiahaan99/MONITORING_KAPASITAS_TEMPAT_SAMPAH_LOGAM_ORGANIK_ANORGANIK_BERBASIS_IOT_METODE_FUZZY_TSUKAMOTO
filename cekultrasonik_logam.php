...
$Nilai_kapasitas_logam = $data['SAMPAH_LOGAM'];
$Waktu = $data['WAKTU'];
$Ukuran = $data['UKURAN'];

if ($Nilai_kapasitas_logam <= 0) {
    $Miu_logam_rendah = 1;
} else if ($Nilai_kapasitas_logam >= 100) {
    $Miu_logam_rendah = 0;
} else {
    $Miu_logam_rendah = (100 - $Nilai_kapasitas_logam) / (100 - 0); //b-x/b-a
}
...
if ($Nilai_kapasitas_logam <= 0) {
    ...
    $Miu_logam_tinggi = ($Nilai_kapasitas_logam - 0) / (100 - 0); //x-a/b-a
...
$alpha_predikat_1 = min($Miu_logam_rendah, $Miu_waktu_rendah); //penuh
$alpha_predikat_2 = min($Miu_logam_tinggi, $Miu_waktu_rendah); //penuh
$alpha_predikat_3 = min($Miu_logam_rendah, $Miu_waktu_tinggi); //tersedia
$alpha_predikat_4 = min($Miu_logam_tinggi, $Miu_waktu_tinggi); //tersedia
