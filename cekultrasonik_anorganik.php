...
$Nilai_kapasitas_anorganik = $data['SAMPAH_ANORGANIK'];
$Waktu = $data['WAKTU'];
$Ukuran = $data['UKURAN'];


if ($Nilai_kapasitas_anorganik <= 0) {
    $Miu_anorganik_rendah = 1;
} else if ($Nilai_kapasitas_anorganik >= 100) {
    $Miu_anorganik_rendah = 0;
} else {
    $Miu_anorganik_rendah = (100 - $Nilai_kapasitas_anorganik) / (100 - 0); //b-x/b-a

}

if ($Nilai_kapasitas_anorganik <= 0) {
    $Miu_anorganik_tinggi = 0;
} else if ($Nilai_kapasitas_anorganik >= 100) {
    $Miu_anorganik_tinggi = 1;
} else {
    $Miu_anorganik_tinggi = ($Nilai_kapasitas_anorganik - 0) / (100 - 0); //x-a/b-a
...
$alpha_predikat_1 = min($Miu_anorganik_rendah, $Miu_waktu_rendah); //penuh
$alpha_predikat_2 = min($Miu_anorganik_tinggi, $Miu_waktu_rendah); //penuh
$alpha_predikat_3 = min($Miu_anorganik_rendah, $Miu_waktu_tinggi); //tersedia
$alpha_predikat_4 = min($Miu_anorganik_tinggi, $Miu_waktu_tinggi); //tersedia
